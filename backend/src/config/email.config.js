 ...
 * @description This file contains email configuration settings for the Kicks Shoes application.
 * It includes Gmail OAuth2 credentials, email templates, and email service settings.
 */
